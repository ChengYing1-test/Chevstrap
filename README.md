...
A: No. As long as you're only running the native Roblox client from an official source such as [Google Play](https://play.google.com/store/apps/details?id=com.roblox.client), and not a modified client, you should be fine. [learn more here](https://github.com/FrosSky/Chevstrap/wiki/Why-you-can't-get-banned-by-Chevstrap)
